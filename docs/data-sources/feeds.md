...
- `feed_type` (String) A filter to search by feed type. Valid feed types are `AwsElasticContainerRegistry`, `BuiltIn`, `Docker`, `GcsStorage`, `GitHub`, `Helm`, `Maven`, `Npm`, `NuGet`, `S3`, `OciRegistry` or `OctopusProject`.

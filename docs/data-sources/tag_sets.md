...
- `scopes` (List of String) A filter to search by scopes. Valid values are `"Tenant"`, `"Environment"`, `"Project"`, `"Runbook"`, `"Target"`.
...
- `scopes` (List of String) The resource scopes this tag set applies to. Valid values are `"Tenant"`, `"Environment"`, `"Project"`, `"Runbook"`, `"Target"`.

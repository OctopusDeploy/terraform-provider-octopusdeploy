...
page_title: "octopusdeploy_pypi_feed Resource - terraform-provider-octopusdeploy"
subcategory: ""
description: |-
  This resource manages a PyPI feed in Octopus Deploy.
---

# octopusdeploy_pypi_feed (Resource)
...
- `space_id` (String) The space ID associated with this PyPI feed.

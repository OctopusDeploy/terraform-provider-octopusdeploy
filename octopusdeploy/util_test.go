...
// The machine policy health check tests below need package access to expandMachineHealthCheckPolicy
// and getMachineHealthCheckPolicySchema, and a new file under octopusdeploy/ fails the SDK
// additions check, so they live here rather than in a file of their own.

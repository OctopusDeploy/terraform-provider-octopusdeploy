...
func TestAccLifecycleRetentionUpdates(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: lifecycle_WithRetention(lifecycleName, "Default", "", "", ""),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLifecycleExists(lifecycleResource),
					resource.TestCheckResourceAttrSet(lifecycleResource, "id"),
					resource.TestCheckResourceAttr(lifecycleResource, "name", lifecycleName),
			...
			{
				Config: lifecycle_WithRetention(lifecycleName, "Forever", "", "", ""),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLifecycleExists(lifecycleResource),
					resource.TestCheckResourceAttrSet(lifecycleResource, "id"),
					resource.TestCheckResourceAttr(lifecycleResource, "name", lifecycleName),
			...
			{
				Config: lifecycle_WithRetention(lifecycleName, "Count", "1", "Days", ""),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLifecycleExists(lifecycleResource),
					resource.TestCheckResourceAttrSet(lifecycleResource, "id"),
					resource.TestCheckResourceAttr(lifecycleResource, "name", lifecycleName),
			...
			{
				Config: lifecycle_WithRetention(lifecycleName, "Count", "1", "Items", ""),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckLifecycleExists(lifecycleResource),
					resource.TestCheckResourceAttrSet(lifecycleResource, "id"),
					resource.TestCheckResourceAttr(lifecycleResource, "name", lifecycleName),
...
func TestAccRetentionAttributeValidation(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Default", "1", "", ""),
				PlanOnly:    true,
			...
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Forever", "1", "", ""),
				PlanOnly:    true,
				ExpectError: regexp.MustCompile(`(?s)quantity_to_keep must not be set when strategy is Forever or Default.*quantity_to_keep must not be set when strategy is Forever or Default`),
			},
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Default", "", "days", ""),
				PlanOnly:    true,
			...
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Forever", "", "items", ""),
				PlanOnly:    true,
				ExpectError: regexp.MustCompile(`(?s)unit must not be set when strategy is Forever or Default.*unit must not be set when strategy is Forever or Default`),
			},
			{
				Config:      lifecycle_WithRetention(lifecycleName, "", "", "", ""),
				PlanOnly:    true,
			...
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Count", "1", "Days", "true"),
				PlanOnly:    true,
			...
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Count", "1", "", ""),
				PlanOnly:    true,
			...
			{
				Config:      lifecycle_WithRetention(lifecycleName, "Count", "", "Days", ""),
				PlanOnly:    true,
...
func lifecycle_WithRetention(lifecycleName string, strategy string, quantityToKeep string, unit string, shouldKeepForever string) string {
